				...
				case 'bf-gin':
				  ...
				  iconColor = 'FFFFFFFF';
						...
						var tex = Paths.getSparrowAtlas('characters/gin');
							...
							animation.addByPrefix('singLEFT', 'gin NOTE LEFT0', 24, false);
							animation.addByPrefix('singRIGHT', 'gin NOTE RIGHT0', 24, false);
							animation.addByPrefix('singDOWN', 'gin NOTE DOWN0', 24, false);
							animation.addByPrefix('singUPmiss', 'gin NOTE UP MISS', 24, false);
							animation.addByPrefix('singLEFTmiss', 'gin NOTE LEFT MISS', 24, false);
							animation.addByPrefix('singRIGHTmiss', 'gin NOTE RIGHT MISS', 24, false);
							animation.addByPrefix('singDOWNmiss', 'gin NOTE DOWN MISS', 24, false);

							animation.addByPrefix('scared', 'gin idle shaking', 24);
